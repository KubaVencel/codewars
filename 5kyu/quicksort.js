...
This kata was inspired by Bubblesort Once and Bubble Sort.
Other kata related to quicksort are Bug Fix - Quick Sort and Verified Sorting Algorithms - Quicksort.
...
function quicksort(data) {
	...
	if (
		snapshot.length > 0 &&
		!arraysEqual(snapshot[snapshot.length - 1], arr)
	) {
		snapshot.push([...arr]);
	}
