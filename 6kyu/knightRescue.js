...
You are given an array containing the ns of all of your knights n-knight jumps, and the coordinates (x, y) of a civilian who need your squad's help.
...
function knightRescue(N,x,y) {
  ...
  return N.filter(e => e % 2 == 0).length > 0;
}
